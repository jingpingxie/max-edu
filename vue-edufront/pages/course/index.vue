            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                ...
                <li v-for="subject in  subjectNestedList" :key="subject.id">
                  <a :title="subject.title" @click="getTwoByOneId(subject.id)" href="#">{{subject.title}}</a>
                </li>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <li v-for="subject in  subSubjectList" :key="subject.id">
                  <a :title="subject.title" @click="getCourseByTwoId(subject.id)" href="#">{{subject.title}}</a>
                </li>
              </ul>
            </dd>
          </dl>
...
export default {
  ...
  methods: {
    getCoursePageVo() {
      this.searchObj = {}
      this.subSubjectList =[]
      course.getCourseApiPageVo(this.page, 8, this.searchObj).then(response => {
