package com.matrix.wxlogin.controller;


import com.matrix.baseservice.handler.MatrixException;
import com.matrix.commonutils.utils.JwtUtils;
import com.matrix.wxlogin.entity.UcenterMember;
import com.matrix.wxlogin.service.UcenterMemberService;
import com.matrix.wxlogin.utils.ConstantPropertiesUtil;
import com.matrix.wxlogin.utils.HttpClientUtils;
...
public class UcenterMemberController {
    ...
    public String wxlogin(){
        ...
        try {
            ...
            throw new MatrixException(20001, e.getMessage());
        }
