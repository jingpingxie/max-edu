...
import com.matrix.orderservice.entity.TPayLog;
import com.matrix.orderservice.mapper.TPayLogMapper;
import com.matrix.orderservice.service.TOrderService;
import com.matrix.orderservice.service.TPayLogService;
import com.matrix.orderservice.utils.HttpClient;
...
public class TPayLogServiceImpl extends ServiceImpl<TPayLogMapper, TPayLog> implements TPayLogService {
    ...
    public Map<String, Object> createNative(String orderNo) {
        try {
            ...
            //1.1校验订单
            if(order==null){
                throw  new MatrixException(20001,"订单失效");
            }
            //2封装支付参数
            Map m = new HashMap();
            //设置支付参数
            ...
            e.printStackTrace();
            throw new MatrixException(20001,"获取二维码失败");
    ...
    public Map<String, String> queryPayStatus(String orderNo) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new MatrixException(20001,"查询订单状态失败");
        }
